                ...
                <div class="form">
                    <form class="form-horizontal " id="" method="post" action="" novalidate="novalidate">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="name" name="name" value="<?php echo $info->name ?>" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="param_sort_order" name="sort_order" value="<?php echo $info->sort_order ?>" type="text">
                                <p class="help-block"><?php echo form_error('name') ?></p>
                            </div>
                        </div>
                        <div class="form-group">
