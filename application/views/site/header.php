        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="logo pull-left">
                    <a href="<?php echo site_url('home') ?>"><img src="<?php echo public_url() ?>site/images/logo.png" alt=""></a>
                </div>
            ...
            <div class="col-sm-8">
                <div class="shop-menu pull-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?php echo site_url('home/cart') ?>"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                    ...
                    <ul class="nav navbar-nav collapse navbar-collapse">
                        ...
                        <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                            <ul role="menu" class="sub-menu">
                                ...
                                <li><a href="<?php echo site_url('home/products_details') ?>">Product Details</a></li> 
                        ...
                        <li class="dropdown"><a href="#">Blog<i class="fa fa-angle-down"></i></a>
                            <ul role="menu" class="sub-menu">
                                <li><a href="<?php echo site_url('home/blog_list') ?>">Blog List</a></li>
                                <li><a href="<?php echo site_url('home/blog_single') ?>">Blog Single</a></li>
                            </ul>
                        </li> 
